...
function setupScrollAnimations() {
  ...
  const animatedElements = document.querySelectorAll('.service-card, .project-card, .stat-card');
...
function handleContactForm(e) {
  ...
  fetch('https://rats24-server.vercel.app/api/contact', {
    method: 'POST',
  ...
  window.showNotification = function (message, type = 'info') {
    ...
    notification.innerHTML = `
            <div class="flex items-center">
                <i class="fas fa-${type === 'success' ? 'check-circle' : 'info-circle'} text-${
